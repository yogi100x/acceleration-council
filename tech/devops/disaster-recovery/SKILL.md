...
Backup strategies, RTO/RPO, failover, chaos engineering, runbooks, multi-region. Design decisions, patterns, and quality standards.

## Research Protocol
### Web Search
- "disaster recovery best practices [current year]"
- "disaster recovery tools comparison [current year]"
...
## Output Protocol
Write to `.claude/outputs/disaster-recovery.md`:
