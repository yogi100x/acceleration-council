...
VPC, DNS, CDN, load balancing L4/L7, WAF, DDoS protection, TLS management. Design decisions, patterns, and quality standards.

## Research Protocol
### Web Search
- "network design best practices [current year]"
- "network design tools comparison [current year]"
...
## Output Protocol
Write to `.claude/outputs/network-design.md`:
