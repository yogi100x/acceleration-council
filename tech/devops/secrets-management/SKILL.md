...
Vault/AWS Secrets Manager, rotation, least privilege, env var hygiene, CI scanning. Design decisions, patterns, and quality standards.

## Research Protocol
### Web Search
- "secrets management best practices [current year]"
- "secrets management tools comparison [current year]"
...
## Output Protocol
Write to `.claude/outputs/secrets-management.md`:
