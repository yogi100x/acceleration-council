...
Docker builds, compose, image optimization, registry management, Kubernetes basics. Design decisions, patterns, and quality standards.

## Research Protocol
### Web Search
- "containerization best practices [current year]"
- "containerization tools comparison [current year]"
...
## Output Protocol
Write to `.claude/outputs/containerization.md`:
