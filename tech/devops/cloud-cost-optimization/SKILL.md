...
Right-sizing, reserved/spot instances, storage tiering, FinOps, cost allocation. Design decisions, patterns, and quality standards.

## Research Protocol
### Web Search
- "cloud cost optimization best practices [current year]"
- "cloud cost optimization tools comparison [current year]"
...
## Output Protocol
Write to `.claude/outputs/cloud-cost-optimization.md`:
