...
Metrics pipeline, log aggregation, trace collection, correlation, dashboards. Design decisions, patterns, and quality standards.

## Research Protocol
### Web Search
- "observability platform best practices [current year]"
- "observability platform tools comparison [current year]"
...
## Output Protocol
Write to `.claude/outputs/observability-platform.md`:
