...
Horizontal/vertical scaling, auto-scaling, capacity planning, load testing, connection pooling. Design decisions, patterns, and quality standards.

## Research Protocol
### Web Search
- "scaling strategy best practices [current year]"
- "scaling strategy tools comparison [current year]"
...
## Output Protocol
Write to `.claude/outputs/scaling-strategy.md`:
