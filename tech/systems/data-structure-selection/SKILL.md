...
When to use hash map, tree, graph, trie, bloom filter, skip list, ring buffer — by access pattern. Decision frameworks for systems-level engineering.

## Research Protocol
### Web Search
- "data structure selection patterns [current year]"
- "data structure selection comparison [current year]"
...
## Output Protocol
Write to `.claude/outputs/data-structure-selection.md`:
