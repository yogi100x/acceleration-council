...
CAP theorem, consensus, eventual consistency, distributed transactions (saga), partition handling. Decision frameworks for systems-level engineering.

## Research Protocol
### Web Search
- "distributed systems patterns [current year]"
- "distributed systems comparison [current year]"
...
## Output Protocol
Write to `.claude/outputs/distributed-systems.md`:
