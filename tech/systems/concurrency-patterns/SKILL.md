...
Mutex/semaphore, actor model, CSP channels, async/await, race conditions, deadlock avoidance. Decision frameworks for systems-level engineering.

## Research Protocol
### Web Search
- "concurrency patterns patterns [current year]"
- "concurrency patterns comparison [current year]"
...
## Output Protocol
Write to `.claude/outputs/concurrency-patterns.md`:
