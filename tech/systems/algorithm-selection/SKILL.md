...
Decision framework for choosing algorithms by access pattern, scale, and constraints. Decision frameworks for systems-level engineering.

## Research Protocol
### Web Search
- "algorithm selection patterns [current year]"
- "algorithm selection comparison [current year]"
...
## Output Protocol
Write to `.claude/outputs/algorithm-selection.md`:
