...
Lexing, parsing, AST, code generation — for DSLs, config languages, template engines. Decision frameworks for systems-level engineering.

## Research Protocol
### Web Search
- "compiler & interpreter design patterns [current year]"
- "compiler & interpreter design comparison [current year]"
...
## Output Protocol
Write to `.claude/outputs/compiler-interpreter-design.md`:
