...
Startup time, memory, battery optimization, network efficiency, list virtualization. Decision frameworks and quality standards for mobile development.

## Research Protocol
### Web Search
- "mobile performance best practices [current year]"
- "mobile performance react native [current year]"
...
## Output Protocol
Write to `.claude/outputs/mobile-performance.md`:
