...
Native vs React Native vs Flutter, offline-first, navigation patterns, state management. Decision frameworks and quality standards for mobile development.

## Research Protocol
### Web Search
- "mobile architecture best practices [current year]"
- "mobile architecture react native [current year]"
...
## Output Protocol
Write to `.claude/outputs/mobile-architecture.md`:
