...
FCM/APNs, deep linking, rich notifications, segmentation, preference management. Decision frameworks and quality standards for mobile development.

## Research Protocol
### Web Search
- "push notification design best practices [current year]"
- "push notification design react native [current year]"
...
## Output Protocol
Write to `.claude/outputs/push-notification-design.md`:
