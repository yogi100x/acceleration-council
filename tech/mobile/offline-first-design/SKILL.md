...
Sync strategies, conflict resolution, local DB (SQLite/WatermelonDB), queue-and-sync. Decision frameworks and quality standards for mobile development.

## Research Protocol
### Web Search
- "offline-first design best practices [current year]"
- "offline-first design react native [current year]"
...
## Output Protocol
Write to `.claude/outputs/offline-first-design.md`:
