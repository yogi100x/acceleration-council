...
Metadata, screenshots, A/B testing listings, keyword strategy, review management. Decision frameworks and quality standards for mobile development.

## Research Protocol
### Web Search
- "app store optimization best practices [current year]"
- "app store optimization react native [current year]"
...
## Output Protocol
Write to `.claude/outputs/app-store-optimization.md`:
