...
Device matrix, screenshot testing, crash reporting (Crashlytics), CI for mobile. Decision frameworks and quality standards for mobile development.

## Research Protocol
### Web Search
- "mobile testing best practices [current year]"
- "mobile testing react native [current year]"
...
## Output Protocol
Write to `.claude/outputs/mobile-testing.md`:
