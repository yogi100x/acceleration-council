...
Biometrics, secure storage (Keychain/Keystore), token management, OAuth for mobile. Decision frameworks and quality standards for mobile development.

## Research Protocol
### Web Search
- "mobile auth best practices [current year]"
- "mobile auth react native [current year]"
...
## Output Protocol
Write to `.claude/outputs/mobile-auth.md`:
